...
export class ParticipantesService {
  private apiUrl = 'http://localhost/api/registro_admin';  // URL de tu API
  ...
  createParticipante(participante: any): Observable<any> {
    return this.http.post(`${this.apiUrl}/createParticipante.php`, participante);
  }

  // Actualizar un participante por ID
  updateParticipante(id: number, participanteData: any): Observable<any> {
    return this.http.put(`${this.apiUrl}/updateParticipante.php?id=${id}`, participanteData);
  }
}
