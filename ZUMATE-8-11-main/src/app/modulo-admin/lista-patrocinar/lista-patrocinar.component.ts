...
@Component({
  selector: 'app-lista-patrocinar',
  templateUrl: './lista-patrocinar.component.html',
  styleUrls: ['./lista-patrocinar.component.css']
})
export class ListaPatrocinarComponent implements OnInit {
  participantes: any[] = [];
