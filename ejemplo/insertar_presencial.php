...
if (isset($data['nombre'], $data['apellidos'], $data['dni'], $data['email'], $data['telefono'], $data['tipoDonacion'])) {
    ...
    $sql = "INSERT INTO entrega_presencial (nombre, apellidos, dni, email, telefono, tipo_donacion) 
            VALUES ('$nombre', '$apellidos', '$dni', '$email', '$telefono', '$tipoDonacion')";
